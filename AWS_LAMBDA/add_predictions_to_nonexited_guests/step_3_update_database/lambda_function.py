...
def lambda_handler(event, context):
    ...
    database table guests with predictions where predictions is null.'''
    ...
    for row in predictions.itertuples():
        with conn.cursor() as cur:
            ...
            sql_query = 'UPDATE guests SET predicted_exit_destination=%s WHERE personal_id=%s AND enroll_date=%s'
